...
def main():
    ...
    current_cookie_string = resp.data[0]['cookies_string']
    log("✅ Cookie ottenuto")
    ...
    while True:
        try:
            ...
            if picmap is None or len(picmap) == 0:
                ...
                risultato = riconosci_captcha_matematico(
                    session.get(f"https://www.easyhits4u.com/simg/{qpic}.jpg", verify=False).content
                )
